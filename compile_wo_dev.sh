...
./pybuda/pybuda/tools/run_net2pipe.py --run-pipegen --run-blobgen --device-yaml=/home/tt-buda/third_party/budabackend/device/wormhole_80_arch.yaml ./pt_bert_question_answering_tt_1_netlist.yaml     
